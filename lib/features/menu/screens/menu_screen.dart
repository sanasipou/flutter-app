                            ...
                            Expanded(
                              child: ListTile(
                                ...
                                title: Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
                                  ...
                                  ) : Container(height: 10, width: 150, color: ResponsiveHelper.isDesktop(context)? ColorResources.getDarkColor(context): Theme.of(context).canvasColor) :
